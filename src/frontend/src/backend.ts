...
export class Backend implements backendInterface {
    ...
    async getAllMovieDetails(): Promise<Array<MovieDetails>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllMovieDetails();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getMovieDetails(arg0: string): Promise<MovieDetails> {
        if (this.processError) {
            try {
                const result = await this.actor.getMovieDetails(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async setMovieDetails(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setMovieDetails(arg0, arg1, arg2, arg3, arg4, arg5);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
